...
import com.sendroids.as.entity.Client;
import com.sendroids.as.repo.ClientRepository;
...
public class JpaRegisteredClientRepository implements RegisteredClientRepository {
    ...
    public List<RegisteredClient> findAll() {
        return this.clientRepository.findAll().stream().map(this::toObject).collect(Collectors.toList());
    }
